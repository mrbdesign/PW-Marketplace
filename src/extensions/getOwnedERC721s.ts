...
export type GetERC721sParams = {
  owner: string;
  // (optional) If pass `25` then the code will limit the RPC requests to 25 requests per second
 ...
 *   contract,
 *   owner: "0x...",
 *   requestPerSec: 25, // limit RPC reqs to 25 reqs per sec to avoid missing/corrupted data
 * });
 *
